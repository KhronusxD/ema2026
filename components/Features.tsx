        ...
        <div className="grid md:grid-cols-3 gap-12">
          ...
          <div className="relative group">
            <div className="aspect-[4/5] overflow-hidden rounded-lg mb-6 grayscale group-hover:grayscale-0 transition-all duration-700 border border-ministry-accent/20">
              <img src="https://picsum.photos/seed/preacher/800/1000" alt="Professores" width="800" height="1000" loading="lazy" className="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-700" />
            </div>
          ...
          <div className="relative group md:-mt-12">
            <div className="aspect-[4/5] overflow-hidden rounded-lg mb-6 grayscale group-hover:grayscale-0 transition-all duration-700 border border-ministry-accent/20">
              <img src="https://picsum.photos/seed/missionamazon/800/1000" alt="Prática Missionária" width="800" height="1000" loading="lazy" className="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-700" />
            </div>
          ...
          <div className="relative group">
            <div className="aspect-[4/5] overflow-hidden rounded-lg mb-6 grayscale group-hover:grayscale-0 transition-all duration-700 border border-ministry-accent/20">
              <img src="https://picsum.photos/seed/praying/800/1000" alt="Formação Integral" width="800" height="1000" loading="lazy" className="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-700" />
            </div>
